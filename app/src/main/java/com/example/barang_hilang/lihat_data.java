    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_arrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(lihat_data.this, dashboard.class);
                startActivity(i);
            }
        });
    }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url_get, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    lihat_data_adapter adapter = new lihat_data_adapter(lihat_data.this,model_data);
                    recyclerView.setAdapter(adapter);

                } catch (JSONException e){
                    Toast.makeText(lihat_data.this, "Error" + e.toString(), Toast.LENGTH_SHORT).show();
                }
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(lihat_data.this, "Error response" + error.toString(), Toast.LENGTH_SHORT).show();
            }
        });
